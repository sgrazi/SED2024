...
//			imprimirCalendario();
		...
		System.arraycopy(generadorTiemposEntreRoturas.getStats(), 0, stats, 0, 2);
		System.arraycopy(generadorTiemposDesarmado.getStats(), 0, stats, 2, 2);
		System.arraycopy(generadorTiemposReparado.getStats(), 0, stats, 4, 2);
		return stats;
	}
